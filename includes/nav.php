                        ...
                        <li>
                            ...
                            <div id="dropdown0" class="dropdown">
                                <ul role="menu" style="font-size: 13px;">
                                    ...
                                    <li role="menuitem">
                                        <a class="dropdown-link" href="../Sea-Books-LSP/gallery.php">
                                            Geleri
                                        </a>
                                    </li>
                                    <li role="menuitem">
                            ...
                            <li>
                                ...
                                <div id="dropdown-admin" class="dropdown">
                                    <ul role="menu" style="font-size: 13px;">
                                        ...
                                        <li role="menuitem">
                                            <a class="dropdown-link" href="bookstable.php">Buku</a>
                                        </li>
                                        <li role="menuitem">
                                            <a class="dropdown-link" href="users.php">Admins List</a>
                                        </li>
                                    </ul>
                                    <ul role="menu" style="font-size: 13px;">
                                        <li>
                                        ...
                                        <li role="menuitem">
                                            <a class="dropdown-link" href="viewstudents.php">Murid & Guru</a>
                                        </li>
                                        <li role="menuitem">
                                            <a class="dropdown-link" href="borrowedbooks.php">Buku Yang Terpinjam</a>
                                        </li>
                                        <li role="menuitem">
                                            <a class="dropdown-link" href="fines.php">Denda</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                <button class="nav-link dropdown-btn" aria-haspopup="true" aria-expanded="false" aria-label="discover" style="font-size: 20px;">
                            ...
                            <li>
                                ...
                                <div id="dropdown-admin" class="dropdown">
                                    ...
                                    <ul role="menu" style="font-size: 13px;">
                                        ...
                                        <li role="menuitem">
                                            <a class="dropdown-link" href="borrow-student.php">Pinjam Buku</a>
