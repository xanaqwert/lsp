...
<body>
	...
	<div class="container" style="margin-top: 10rem;">
		<div class="col-lg-8 col-md-10 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-1">
			<div class="jumbotron login" style="background-color: white !important; border-radius: 15px; border: 1px solid black">
				...
				<form class="form-horizontal" role="form" method="post" action="login.php" enctype="multipart/form-data">
					...
					<div class="form-group">
						<labfel for="password" class="col-sm-2 control-label">Password</labfel>
						<div class="col-sm-10">
